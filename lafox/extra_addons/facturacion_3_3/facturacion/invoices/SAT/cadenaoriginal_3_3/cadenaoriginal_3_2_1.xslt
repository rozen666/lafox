...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:ecc="http://www.sat.gob.mx/ecc" xmlns:psgecfd="http://www.sat.gob.mx/psgecfd" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:detallista="http://www.sat.gob.mx/detallista" xmlns:ecb="http://www.sat.gob.mx/ecb" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:ventavehiculos="http://www.sat.gob.mx/ventavehiculos" xmlns:pfic="http://www.sat.gob.mx/pfic" xmlns:tpe="http://www.sat.gob.mx/TuristaPasajeroExtranjero" xmlns:leyendasFisc="http://www.sat.gob.mx/leyendasFiscales">
  ...
  -->
  <xsl:include href="http://safebus.bpmtech.com:8084/utilerias.xslt"/>
  <!-- 
    En esta sección se define la inclusión de las demás plantillas de transformación para 
    la generación de las cadenas originales de los complementos fiscales 
  -->
  <xsl:include href="http://safebus.bpmtech.com:8084/ecc.xslt"/>
  <xsl:include href="http://safebus.bpmtech.com/psgecfd.xslt"/>
  <xsl:include href="http://safebus.bpmtech.com/donat11.xslt"/>
  <xsl:include href="http://safebus.bpmtech.com/divisas.xslt"/>
  <xsl:include href="http://safebus.bpmtech.com/ecb.xslt"/>
  <xsl:include href="http://safebus.bpmtech.com/detallista.xslt"/>
  <xsl:include href="http://safebus.bpmtech.com/implocal.xslt"/>
  <xsl:include href="http://safebus.bpmtech.com/terceros11.xslt"/>
  <xsl:include href="http://safebus.bpmtech.com/iedu.xslt"/>
  <xsl:include href="http://safebus.bpmtech.com/ventavehiculos11.xslt"/>
  <xsl:include href="http://safebus.bpmtech.com/pfic.xslt"/>
  <xsl:include href="http://safebus.bpmtech.com/TuristaPasajeroExtranjero.xslt"/>
  <xsl:include href="http://safebus.bpmtech.com/leyendasFisc.xslt"/>
